export const translations = {
  pt: {
    ...
    experience: {
      ...
      item1: { year: "O Início", title: "Estudando linguagem C", company: "Estudante Engenharia Eletrônica UTFPR", description: "Tudo começou quando vi programação pela primeira vez na UTFPR. A linguagem C me fascinou por sua proximidade com o hardware e a capacidade de criar sistemas eficientes do zero." },
      item2: { year: "2025 - Presente", title: "Estudante de T.A.D.S", company: "Análise e Desenvolvimento de Sistemas", description: "Aprofundamento acadêmico em arquiteturas de software, lógica de programação avançada e padrões de projeto." },
      item3: { year: "2025 - Presente", title: "Desenvolvedor Full Stack Autônomo", company: "Projetos Freelance & Enterprise", description: "Desenvolvimento de sistemas escaláveis e de alta complexidade (como o WMS Estoque Raiz e o JGTech Brasil). Foco em microserviços, performance com Redis e interfaces modernas. Cada vez mais aprendendo novas linguagens para aprofundar minha visão de software e arquitetura." },
      item4: { year: "2026 - Presente", title: "Entusiasta em Segurança Ofensiva", company: "Estudos em Cybersegurança", description: "Exploração de vulnerabilidades web (como falhas IDOR), uso de ferramentas do Kali Linux e foco em construir aplicações blindadas desde o código fonte." },
  ...
  en: {
    ...
    experience: {
      ...
      item1: { year: "The Beginning", title: "Studying C Language", company: "Electronic Eng. Student at UTFPR", description: "It all started when I saw programming for the first time at UTFPR. The C language fascinated me due to its proximity to hardware and the ability to create efficient systems from scratch." },
      item2: { year: "2025 - Present", title: "S.D.A Student", company: "Systems Design and Analysis", description: "Academic deepening in software architectures, advanced programming logic, and design patterns." },
      item3: { year: "2025 - Present", title: "Freelance Full Stack Developer", company: "Freelance & Enterprise Projects", description: "Development of scalable and highly complex systems (like WMS Estoque Raiz and JGTech Brasil). Focus on microservices, performance with Redis, and modern interfaces. Increasingly learning new languages to deepen my vision of software and architecture." },
      item4: { year: "2026 - Present", title: "Offensive Security Enthusiast", company: "Cybersecurity Studies", description: "Exploration of web vulnerabilities (like IDOR flaws), use of Kali Linux tools, and focus on building armored applications from the source code." },
